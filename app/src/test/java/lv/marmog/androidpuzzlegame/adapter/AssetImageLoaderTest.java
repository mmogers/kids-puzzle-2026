...
public class AssetImageLoaderTest {

    @Test
    public void calculateScaleFactor_downscalesToWholeFactor() {
    ...
    @Test
    public void calculateScaleFactor_usesTheLessAggressiveDimension() {
    ...
    @Test
    public void calculateScaleFactor_returnsZeroWhenPhotoSmallerThanTarget() {
